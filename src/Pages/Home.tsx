  ...
  return (
    <div className="tourism-page overflow-hidden bg-[#f6efe5] text-slate-900">
      ...
      >
        ...
        <div className="relative mx-auto flex min-h-[82vh] max-w-7xl items-center px-6 py-18 sm:px-8 lg:px-10">
          <div className="tourism-glass max-w-4xl rounded-[2rem] p-8 text-left text-white shadow-[0_30px_80px_rgba(15,23,42,0.35)] sm:p-10 lg:p-12">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                href="/turismo"
                className="inline-flex items-center justify-center rounded-full border border-amber-400 bg-amber-500 px-7 py-4 text-sm font-semibold uppercase tracking-[0.25em] text-stone-950 transition hover:-translate-y-0.5 hover:bg-amber-400"
              >
                Descubrir Driebes
              </a>
              <a
                href="/eventos"
                className="inline-flex items-center justify-center rounded-full border border-white/30 bg-white/10 px-7 py-4 text-sm font-semibold uppercase tracking-[0.25em] text-white backdrop-blur-sm transition hover:-translate-y-0.5 hover:bg-white/15"
              >
                Ver eventos
              </a>
            </div>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Patrimonio</p>
                <p className="mt-1 text-sm text-stone-200">Historia que sigue presente</p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Naturaleza</p>
                <p className="mt-1 text-sm text-stone-200">Rutas, horizonte y calma rural</p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Cercania</p>
                <p className="mt-1 text-sm text-stone-200">Servicios y vida de pueblo</p>
              </div>
            </div>
          </div>
        </div>
