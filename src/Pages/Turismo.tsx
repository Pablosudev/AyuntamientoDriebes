      ...
      >
        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-7xl items-center px-6 py-18 sm:px-8 lg:px-10">
          <div className="tourism-glass max-w-3xl rounded-[2rem] p-8 text-left text-white shadow-[0_30px_80px_rgba(15,23,42,0.35)] sm:p-10 lg:p-12">
            ...
            <h1 className="tourism-display text-5xl leading-none sm:text-6xl lg:text-8xl lg:mb-8">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Historia viva</p>
                <p className="mt-1 text-sm text-stone-200">Iglesia, plaza y legado rural</p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Rutas tranquilas</p>
                <p className="mt-1 text-sm text-stone-200">Senderos para todos los ritmos</p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Escapada local</p>
                <p className="mt-1 text-sm text-stone-200">Gastronomí­a y descanso rural</p>
              </div>
            </div>
          </div>
        </div>
