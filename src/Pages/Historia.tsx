          ...
          <div className="tourism-glass max-w-3xl rounded-[2rem] p-8 text-left text-white shadow-[0_30px_80px_rgba(15,23,42,0.35)] sm:p-10 lg:p-12">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                ...
                <p className="mt-1 text-sm text-stone-200">Huellas visibles del pasado</p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Tradicion</p>
                <p className="mt-1 text-sm text-stone-200">Costumbres que siguen vivas</p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-4 backdrop-blur-sm">
                <p className="text-2xl font-semibold text-white">Comunidad</p>
                <p className="mt-1 text-sm text-stone-200">Una memoria construida entre todos</p>
              </div>
            </div>
          </div>
        </div>
